...
const ConversationListItem = memo((props) => {
  const { conversation, handleSelect } = props;
...
export function ConversationList({ onSelect }: ConversationListProps) {
  ...
  if (!conversations || !conversations.length) {
    return <div className="p-4 text-center text-gray-500">Error fetching conversations</div>;
  }
